...
class User extends \Core\Model {
    ...
    /**
     * Validate current property values, adding valiation error messages to errors array property
     *
     * @return void
     */
    public function validate() {
        ...
        if (isset($this->password)) {
            ...
            if (strlen($this->password) < 6) {
                $this->errors[] = "Please enter at least 6 characters of password";
            }
     ...
     * @param string $email email address to search for
     *
     * @return mixed User object if found, false other wise
     */
     ...
     *
     * @return mixed the user object or false if authentication failed
     */
    ...
    public function rememberLogin() {
        ...
        $this->expiry_timestamp = time() + 60 * 60 * 24 * 30; // 30 dayes from now
    ...
    /**
     * Send password reset instructions to the user specifies
     *
     ...
     * @return void
     */
    protected function startPasswordResest() {
     ...
     *
     * @return mixed User object if found and the token hasn't expires, null otherwise
     */
    ...
    /**
     * Activate the user account with the specified acticavtion token
     *
     ...
     *
     * @param array $data Data from the profile form
     *
